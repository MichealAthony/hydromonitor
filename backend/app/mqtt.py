...
class MQTT:
    ...
    sub_topics = [("620160532_pub", 0), ("620160532", 0), ("620160532_sub", 0)] #  A list of tuples of (topic, qos). Both topic and qos must be present in the tuple.
    ...
    def __init__(self,mongo):
        ...
        self.client.message_callback_add("620160532", self.update)
